...
public class Gestor_Empleado {
    ...
    public static LinkedList<Empleado> Consultar_Empleado(int atributo, String valor){
        ...
        String sql="";
            ...
            switch(atributo){
                //Buscar por ID
                case 1 -> sql="select * from empleado where id_empl='"+valor+"'";
                
                //Buscar por nombre
                case 2 -> sql="select * from empleado where nom_empl='"+valor+"'";
                
                //Buscar por número celular
                case 3 -> sql="select * from empleado where num_empl='"+valor+"'";
                
                //Buscar por fecha de ingreso
                case 4 -> sql="select * from empleado where fech_ingreso_empl='"+valor+"'";

 ...
 * @author NN
 */
public class MenuEmpl_JFrame extends javax.swing.JFrame {
    
    private static MenuEmpl_JFrame menu;
    /**
     * Creates new form Menu_JFrame
     */
     private MenuEmpl_JFrame() {
        initComponents();
        this.setLocationRelativeTo(null);
        lbl_usuario.setText("Usuario: "+Login.getNombre());
    }
     
     public static MenuEmpl_JFrame getMenu(){
         if(menu==null){
             menu= new MenuEmpl_JFrame();
         }
         return menu;
     }
    ...
    private void btn_configuracionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_configuracionActionPerformed
        // TODO add your handling code here:
        ConfigUser_JFrame confi= new ConfigUser_JFrame();
        confi.show();
        this.dispose();

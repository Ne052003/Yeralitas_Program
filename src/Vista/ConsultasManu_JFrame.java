...
import Controlador.ConsultaManu_Control;
import Modelo.Login;
 ...
 * @author NN
 */
public class ConsultasManu_JFrame extends javax.swing.JFrame {

    private ConsultaManu_Control manuconControl;
    private DefaultTableModel tabla;
    /**
     * Creates new form ConsultasEmpl_JFrame
     */
    public ConsultasManu_JFrame() {
        initComponents();
        ...
        manuconControl= new ConsultaManu_Control(this);
        String titulos[]={"ID","Nombre","Precio"};
        tabla= new DefaultTableModel(null,titulos);
        table_manu.setModel(tabla);
        btn_buscar.addActionListener(manuconControl);
    }
    ...
    private void initComponents() {
        ...
        setTitle("Consultas - Manufacturas");
        ...
        combox_filtro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "Precio", "ID" }));
        ...
        jLabel1.setText("Consultar - Manufactura");
        ...
        combox_consulta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Seleccione--", "Consultas - Clientes", "Consultas - Ventas", "Inventario" }));
        ...
        table_manu.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        ...
        table_manu.setMaximumSize(new java.awt.Dimension(1200, 80));
        jScrollPane_Tabla.setViewportView(table_manu);
    ...
    public javax.swing.JTable table_manu;

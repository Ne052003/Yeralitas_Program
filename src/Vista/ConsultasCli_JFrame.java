 ...
 * @author NN
 */
public class ConsultasCli_JFrame extends javax.swing.JFrame {

    private ConsultaCli_Controlador ConsultaCli;
    private DefaultTableModel tabla;
    
    public ConsultasCli_JFrame() {
        initComponents();
        ...
        ConsultaCli = new ConsultaCli_Controlador(this);
        String titulos[] = {"ID", "Nombre", "Número celular", "Dirección"};
        tabla = new DefaultTableModel(null, titulos);
        table_cli.setModel(tabla);
        btn_buscar.addActionListener(ConsultaCli);
    ...
    private void initComponents() {
        ...
        combox_filtro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "ID", "Numero celular" }));
        ...
        combox_consulta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Seleccione--", "Consultas - Ventas", "Inventario" }));
        ...
        table_cli.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        table_cli.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Número celular", "Dirección"
            }
        ) {
        ...
        table_cli.setMaximumSize(new java.awt.Dimension(1200, 80));
        table_cli.getTableHeader().setReorderingAllowed(false);
        jScrollPane_Tabla.setViewportView(table_cli);
